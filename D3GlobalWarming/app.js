...
const dataTemperaturesLength = dataTemperatures.length 

const transTemperaturesDown2Delay = d3.max(dataTemperatures.map((d) => d.dd2));
const transTemperaturesUp2Delay   = d3.max(dataTemperatures.map((d) => d.du2));
const transTemperaturesDown3Delay = d3.max(dataTemperatures.map((d) => d.dd3));
const transTemperaturesUp3Delay   = d3.max(dataTemperatures.map((d) => d.du3));
